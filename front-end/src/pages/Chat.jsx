...
function Chat() {
  ...
  const handelSumbit = async (e) => {
    ...
    setChats((chats) => {
      ...
      return [...updatedChats, { user: "gpt", chat: response.data.choices[0].message.content }];
    });
  };
      ...
      <div className="chatApp">
        ...
        <section className="main">
          ...
          <div className="chatBox">
            ...
            {/* {loading && <div>Loading...</div>} Show "Loading..." text when loading is true */}
          </div>
        </section>
      </div>
    </div>
